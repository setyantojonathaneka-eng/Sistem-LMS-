...
<html lang="id">
  <head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/Logo LearnPath .png')); ?>" />
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/home.css', 'resources/js/app.js']); ?>
    ...
    <div class="layout">
      ...
      <aside class="sidebar" id="sidebar">
        ...
        <div class="inner">
          <div class="sidebar-header">
            <img src="<?php echo e(asset('images/Logo LearnPath .png')); ?>" class="logo" alt="LearnPath logo" />
      ...
      <aside class="sidebar-right">
        ...
        <div class="right-card login-cta-card">
          ...
          <a href="<?php echo e(url('/login')); ?>" class="btn-login">Masuk ke Akun</a>
        </div>
...
</html><?php /**PATH C:\Users\lenovo\LearnPath\resources\views/home.blade.php ENDPATH**/ ?>